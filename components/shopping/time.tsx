...
export default function Index() {
    return (
        <div className="w-[1200px] bg-white rounded-xl px-[22px] py-[26px] mx-auto my-5">
            ...
            >
                <div>
                    <RadioCard value="1" bgType="purple"></RadioCard>
                    <RadioCard value="2" bgType="purple"></RadioCard>
                    <RadioCard value="3" bgType="purple"></RadioCard>
                    <RadioCard value="4" bgType="purple"></RadioCard>
                    <RadioCard value="5" bgType="purple"></RadioCard>
                </div>
            </RadioGroup>
