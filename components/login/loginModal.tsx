...
export default function WXLogin(props: any) {
    ...
    return (
        <div className="w-full justify-center items-center flex flex-col min-h-full bg-[rgba(0,0,0,.68)]">
            <div className="flex flex-col flex-1 justify-center items-center">
                ...
                <div className="w-[380px] h-[468px]">
                    <iframe
                        src="https://open.weixin.qq.com/connect/qrconnect?appid=wx91fb06c6e4e12145&redirect_uri=http%3A%2F%2F218.29.188.60%3A3000%2Flogin&response_type=code&scope=snsapi_login&state=1bqtbpa0oag6nc4x4tcd4yodu084re30"
                        frameborder="0"
                    ></iframe>
                </div>
            </div>
