...
const RightIcon = ({ fill = "currentColor", filled, size, height, width, ...props }: iconProps) => {
    return (
        <svg
            width={size || width || 24}
                ...
                <g transform="translate(-1277.000000, -299.000000)" stroke="#FFEBD5">
                    <g transform="translate(119.000000, 102.000000)">
                        <g transform="translate(0.000000, 197.000000)">
                            <g transform="translate(1180.000013, 22.000013) scale(-1, 1) translate(-1180.000013, -22.000013) translate(1159.000000, 1.000000)">
                                <path
