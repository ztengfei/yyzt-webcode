...
const DeleteIcon = ({
    ...
    return (
        <svg
            ...
            {...props}
        >
            <g id="设计3.0" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g
                    id="07"
